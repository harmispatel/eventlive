...
import eventdetail1 from '../../assets/img/eventdetail1.png';
...
import {FaTwitter,FaMinus } from "react-icons/fa";
import {BsPlusLg,BsFillEnvelopeFill,BsFillKeyFill,BsChevronRight,BsFillPersonFill } from "react-icons/bs";
      ...
      <Fragment>
          ...
          <section className="eventdetail-banner">
            <div className="container">
              <div className="eventdetail-ticket-main layout2">
                <div className="row">
                  <div className="col-lg-4">
                    <div className="eventdetail-inr-left">
                      <div className="eventdetail-img">
                        <img src={eventdetail1} className="w-100"/>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="eventdetail-inr-right">
                      <div className="eventdetail-info">
                        <div className="sec-title">
                          <h3>Gasparilla Music Festival 5055</h3>
                        </div>
                  ...
                  <div className="row">
                    <div className="col-lg-6">
                      <div className="ticket-bt-inr">
                        <a className="btn btn-orange" href="/shopingcart">ADD TO CART <BsPlusLg/></a>
                        <div className="ticket-main d-flex">
                          <div className="add-ticket d-flex">
                            <button className="btn add-bt"><FaMinus/></button>
                            <button className="btn add-bt"><BsPlusLg/></button>
                          </div>
